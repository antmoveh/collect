...
#build_dict = {'module': '排期模块', 'pom': 'cias-base/pom.xml', 'project': 'model', 'git_file': '/cias-base', 'version': '1.0.0', 'order': 1, 'package_type': '.jar', 'package': 'package_version-SNAPSHOT.jar', 'git': 'http://git.kokozu.net/zhangkaixiang/cias-projects.git', 'maven': '-U clean package -Dmaven.test.skip=true -X', 'branch': 'master'}
